{
    "name": "Supplier Pricelist Sync v3.7 (Freemium - Required Fields & Scheduled Imports)",
    "version": "19.0.3.7.0",
    "summary": "Supplier import with required field validation, manual (FREE) and scheduled (PRO) imports",
    "description": """
...
- **NEW: Required Field Validation** - Mark critical fields as required to prevent incomplete imports
